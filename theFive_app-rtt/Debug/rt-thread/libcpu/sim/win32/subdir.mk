...
C_SRCS += \
../rt-thread/libcpu/sim/win32/cpu_port.c 

OBJS += \
./rt-thread/libcpu/sim/win32/cpu_port.o 

C_DEPS += \
./rt-thread/libcpu/sim/win32/cpu_port.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/libcpu/sim/win32/%.o: ../rt-thread/libcpu/sim/win32/%.c
	@echo 'Building file: $<'
