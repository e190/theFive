...
#undef  log_d
#endif
#define log_d(...)                     rt_kprintf("[D/FAL] (%s:%d) ", __FUNCTION__, __LINE__);           rt_kprintf(__VA_ARGS__);rt_kprintf("\n")
...
#undef  log_e
#endif
#define log_e(...)                     rt_kprintf("\033[31;22m[E/FAL] (%s:%d) ", __FUNCTION__, __LINE__);rt_kprintf(__VA_ARGS__);rt_kprintf("\033[0m\n")

/* info level log */
#ifdef  log_i
#undef  log_i
#endif
#define log_i(...)                     rt_kprintf("\033[32;22m[I/FAL] ");                                rt_kprintf(__VA_ARGS__);rt_kprintf("\033[0m\n")
